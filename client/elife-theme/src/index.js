...
export default {
  ...
  icons: {
    ...
    '@pubsweet-pending.FileUploads.Editor.Bold': icons.FormatBold,
    '@pubsweet-pending.FileUploads.Editor.Italic': icons.FormatItalic,
    '@pubsweet-pending.FileUploads.Editor.Underlined': icons.FormatUnderlined,
    '@pubsweet-pending.FileUploads.Editor.Subscript': icons.FormatSubscript,
    '@pubsweet-pending.FileUploads.Editor.Superscript': icons.FormatSuperscript,
